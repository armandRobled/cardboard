...
LensDistortion::LensDistortion(const uint8_t* encoded_device_params, int size,
                               int display_width, int display_height, float inter_lens_distance, float inter_pupillary_distance) {
  ...
  if (inter_pupillary_distance >= 0) {
    IPD = inter_pupillary_distance;
  }
